...
export const headSections: CitSectionConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      field({ field: 'correlationNo', label: '关联号码', type: 'input', maxLength: 500, span: 10 }),
      field({ field: 'correlationReasonFlag', label: '关联理由', type: 'select', optionSource: 'correlationReason', maxLength: 2, span: 10 }),
