...
export const headSections: CitSectionConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      field({ field: 'purpOrgCode', label: '目的地海关', type: 'select', optionSource: 'customs', maxLength: 4, span: 12 }),
      field({ field: 'despDate', label: '启运日期', type: 'date', span: 12 }),
      field({ field: 'blNo', label: 'B/L号', maxLength: 50, span: 12 }),
      field({ field: 'specDeclFlag', label: '特种业务标识', maxLength: 10, span: 12 }),
