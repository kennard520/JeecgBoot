...
public class CustomApiFileController {
    ...
    public Result<FileUploadUrlResponse> uploadUrl(@RequestBody FileUploadUrlRequest request, HttpServletRequest servletRequest) {
        CustomApiApp app = appService.requireApp(servletRequest);
        return Result.OK(fileService.createUploadUrl(app, request, servletRequest));
    }
