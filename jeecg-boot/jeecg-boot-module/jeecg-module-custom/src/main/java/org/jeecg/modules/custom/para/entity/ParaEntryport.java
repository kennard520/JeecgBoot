...
@Schema(description = "口岸")
@TableName("PARA_ENTRYPORT")
public class ParaEntryport implements Serializable {
    ...
    /**
     * 编码；字段名: PORT_CODE；数据类型: VARCHAR2；长度: 6；可空: 是
     */
    ...
    /**
     * 中文名称；字段名: PORT_C_COD；数据类型: VARCHAR2；长度: 64；可空: 是
     */
    ...
    /**
     * 英文名称；字段名: PORT_E_COD；数据类型: VARCHAR2；长度: 64；可空: 是
     */
    ...
    /**
     * PORT_LINE；字段名: PORT_LINE；数据类型: VARCHAR2；长度: 4；可空: 是
     */
    ...
    /**
     * PORT_COUNT；字段名: PORT_COUNT；数据类型: VARCHAR2；长度: 5；可空: 是
     */
    ...
    /**
     * QUARANTINE；字段名: QUARANTINE；数据类型: VARCHAR2；长度: 1；可空: 是
     */
    ...
    /**
     * 关别；字段名: CUSTOMS_CODE；数据类型: VARCHAR2；长度: 64；可空: 是
     */
    @TableField("customs_code")
    @Excel(name = "关别", width = 15)
    @Schema(description = "关别")
