...
/**
 * PARA_EXCHRATE_REL_TEMP ParaExchrateRelTemp。
 *
...
@Schema(description = "PARA_EXCHRATE_REL_TEMP")
@TableName("PARA_EXCHRATE_REL_TEMP")
public class ParaExchrateRelTemp implements Serializable {
    private static final long serialVersionUID = 1L;

    /**
     * BEGIN_DATE；字段名: BEGIN_DATE；数据类型: DATE；长度: 3；可空: 否
     */
    @TableId(value = "begin_date", type = IdType.INPUT)
    ...
    /**
     * CURR_CODE；字段名: CURR_CODE；数据类型: VARCHAR2；长度: 32；可空: 否
     */
