...
@Schema(description = "报文属性attributes")
@TableName("CIT_ATTRIBUTES")
public class CitAttributes implements Serializable {
    ...
    private Long id;
    /**
     * 接口版本号；字段代码: Version；数据类型: String；长度: 5；暂存必填: 是；申报必填: 是
     */
    @TableField("version")
    @Excel(name = "接口版本号", width = 15)
